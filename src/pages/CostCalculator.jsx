                    ...
                    Object.keys(formData).map((key, index) => {
                        return (
                            <div key={index} className='flex flex-col gap-1'>
                                ...
                                <input className='outline outline-2 outline-slate-300 focus:border-none focus:outline-blue-900 py-2 px-5 rounded-lg duration-300' type="number" id={key} name={key} value={formData[key]} onChange={onChange}
